...
import com.kpitb.zakatandusher.Adapter.MainPageAdapterPashto;
import com.kpitb.zakatandusher.Adapter.MainPageAdapterUrdu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        language_chnge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(ZakatSchemes.this);
