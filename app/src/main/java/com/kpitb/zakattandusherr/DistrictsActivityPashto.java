...
import com.kpitb.zakattandusherr.Adapter.DistrictAdapterPashto;
import com.kpitb.zakattandusherr.Adapter.DistrictAdapterUrdu;
...
public class DistrictsActivityPashto extends AppCompatActivity implements SearchView.OnQueryTextListener,
        SwipeRefreshLayout.OnRefreshListener{
    //private DistrictModel districtModel;
    private RecyclerView mRecyclerView;
    DistrictAdapterPashto myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_districts_pashto);
        ...
        txt_urdu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txt_urdu.setTextColor(ContextCompat.getColor(DistrictsActivityPashto.this, R.color.colorPrimaryDark));
        ...
        txt_eng.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txt_eng.setTextColor(ContextCompat.getColor(DistrictsActivityPashto.this,R.color.colorPrimaryDark));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    myAdapter = new DistrictAdapterPashto(DistrictsActivityPashto.this,districtModelArrayList);
                    mRecyclerView.setAdapter(myAdapter);
                    myAdapter.notifyDataSetChanged();
                    if (myAdapter.getItemCount() == 0){
                        Toast.makeText(DistrictsActivityPashto.this, "EMPTY", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e)
                {
                    Toast.makeText(DistrictsActivityPashto.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() != null) {
                    Toast.makeText(DistrictsActivityPashto.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
                    Log.e("Errror",error.getMessage());
                }
                else {
                    Log.e("Errror",error.getMessage());
                    Toast.makeText(DistrictsActivityPashto.this, "Server error, try again", Toast.LENGTH_SHORT).show();
                }
            }
        });
   ...
   /* private void setUpRescyclerView() {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(DistrictsActivityPashto.this);
