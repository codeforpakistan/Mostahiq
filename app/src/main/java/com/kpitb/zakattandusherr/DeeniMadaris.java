    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(DeeniMadaris.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(DeeniMadaris.this,DeeniMadarisUrdu.class));
                            finish();
                            dialog.dismiss();
                        }
                        else if (radioPashto.isChecked() == true)
                        {
                            startActivity(new Intent(DeeniMadaris.this,DeeniMadarisPashto.class));
                            finish();
                            dialog.dismiss();
                        }
                        else {
