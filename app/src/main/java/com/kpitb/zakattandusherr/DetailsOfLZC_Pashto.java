...
public class DetailsOfLZC_Pashto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_of_l_z_c__pashto);
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT < 23) {
                    ...
                    if (ActivityCompat.checkSelfPermission(DetailsOfLZC_Pashto.this,
                        ...
                        ActivityCompat.requestPermissions((Activity) DetailsOfLZC_Pashto.this,
    ...
    private void phoneCall(String phoneNum) {
        if (ActivityCompat.checkSelfPermission(DetailsOfLZC_Pashto.this,
            ...
            DetailsOfLZC_Pashto.this.startActivity(callIntent);
        }else{
            Toast.makeText(DetailsOfLZC_Pashto.this, "تاسو اجازه نه لرئ ۔", Toast.LENGTH_SHORT).show();
        }
