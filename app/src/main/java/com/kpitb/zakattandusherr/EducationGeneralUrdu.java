...
public class EducationGeneralUrdu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_education_general_urdu);
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(EducationGeneralUrdu.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(EducationGeneralUrdu.this,EducationGeneralPashto.class));
                            finish();
                            dialog.dismiss();
                        }
                        else {
                            startActivity(new Intent(EducationGeneralUrdu.this,EducationGeneral.class));
                            finish();
                            dialog.dismiss();
                        }
