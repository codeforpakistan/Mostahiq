    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(EducationProfessional.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(EducationProfessional.this,EducationProfessionalUrdu.class));
                            finish();
                            dialog.dismiss();
                        }
                        else if (radioPashto.isChecked() == true)
                        {
                            startActivity(new Intent(EducationProfessional.this,EducationProfessionalPashto.class));
                            finish();
                            dialog.dismiss();
                        }
                        else {
