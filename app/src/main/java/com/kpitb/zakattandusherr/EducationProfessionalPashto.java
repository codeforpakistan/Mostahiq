...
public class EducationProfessionalPashto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_education_professional_pashto);
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(EducationProfessionalPashto.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(EducationProfessionalPashto.this,EducationProfessionalUrdu.class));
                            finish();
                            dialog.dismiss();
                        }
                        else if (radioPashto.isChecked() == true)
                        {
                            ...
                            startActivity(new Intent(EducationProfessionalPashto.this,EducationProfessional.class));
                            finish();
                            dialog.dismiss();
                        }
