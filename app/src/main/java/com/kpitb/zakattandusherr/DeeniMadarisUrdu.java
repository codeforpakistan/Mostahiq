...
public class DeeniMadarisUrdu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deeni_madaris_urdu);
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(DeeniMadarisUrdu.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(DeeniMadarisUrdu.this,DeeniMadarisPashto.class));
                            finish();
                            dialog.dismiss();
                        }
                        else {
                            startActivity(new Intent(DeeniMadarisUrdu.this,DeeniMadaris.class));
                            finish();
                            dialog.dismiss();
                        }
