...
import com.kpitb.zakattandusherr.Hospital_DetailPagePashto;
import com.kpitb.zakattandusherr.Hospital_DetailPageUrdu;
import com.kpitb.zakattandusherr.Modal.SourceList;
import com.kpitb.zakattandusherr.R;

import java.util.ArrayList;

public class HospitalListAdapterPashto extends RecyclerView.Adapter<HospitalListAdapterPashto.ViewHolder> {
    ...
    public HospitalListAdapterPashto(Context context, ArrayList<SourceList> data) {
...
//            final String phoneNo = c.getDescription();
            ...
            hospitalName.setText(c.getHos_name_pashto());
                    ...
                    YoYo.with(Techniques.Landing)
                            ...
                            .withListener(new Animator.AnimatorListener() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    ...
                                    Intent intent = new Intent(context, Hospital_DetailPagePashto.class);
