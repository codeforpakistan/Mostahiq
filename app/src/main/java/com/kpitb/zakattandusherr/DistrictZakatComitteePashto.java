...
import com.kpitb.zakattandusherr.Adapter.LZCAdapterPashto;
import com.kpitb.zakattandusherr.Adapter.LZCAdapterUrdu;
...
public class DistrictZakatComitteePashto extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_district_zakat_comittee_pshto);
    ...
    private void loadAPIData() {
        String url = "http://mustahiq.mawaiskhan.com/API/localZakatCommitte/" + "?dist_id=" +Id;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    myAdapter = new LZCAdapterPashto(DistrictZakatComitteePashto.this,lzcModels);
                    myAdapter.notifyDataSetChanged();
                    mRecyclerView.setAdapter(myAdapter);
                    if (myAdapter.getItemCount() == 0){
                        Toast.makeText(DistrictZakatComitteePashto.this, "EMPTY", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e)
                {
                    Toast.makeText(DistrictZakatComitteePashto.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() != null) {
                    Toast.makeText(DistrictZakatComitteePashto.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
                    Log.e("Errror",error.getMessage());
                }
                else {
                    Log.e("Errror",error.getMessage());
                    Toast.makeText(DistrictZakatComitteePashto.this, "Server error, try again", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT < 23) {
                    ...
                    if (ActivityCompat.checkSelfPermission(DistrictZakatComitteePashto.this,
                        ...
                        ActivityCompat.requestPermissions(DistrictZakatComitteePashto.this,
    ...
    private void phoneCall(String phoneNo) {
        if (ActivityCompat.checkSelfPermission(this,
            ...
            Toast.makeText(this, "تاسو اجازه نه لرئ ۔", Toast.LENGTH_SHORT).show();
        }
    }
