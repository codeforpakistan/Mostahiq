    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(EducationGeneralPashto.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(EducationGeneralPashto.this,EducationGeneralUrdu.class));
                            finish();
                            dialog.dismiss();
                        }
                        else if (radioPashto.isChecked() == true)
                        {
                            ...
                            startActivity(new Intent(EducationGeneralPashto.this,EducationGeneral.class));
                            finish();
                            dialog.dismiss();
                        }
