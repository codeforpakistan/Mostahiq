    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(Marriage_Allowance_Pashto.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(Marriage_Allowance_Pashto.this,Marriage_Allowance_Urdu.class));
                            finish();
                            dialog.dismiss();
                        }
                        else if (radioPashto.isChecked() == true)
                        {
                            ...
                            startActivity(new Intent(Marriage_Allowance_Pashto.this,MarriageAllownce.class));
                            finish();
                            dialog.dismiss();
                        }
                    }
