...
public class DeeniMadarisPashto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deeni_madaris_pashto);
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(DeeniMadarisPashto.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(DeeniMadarisPashto.this,DeeniMadarisUrdu.class));
                            finish();
                            dialog.dismiss();
                        }
                        else if (radioPashto.isChecked() == true)
                        {
                            ...
                            startActivity(new Intent(DeeniMadarisPashto.this,DeeniMadaris.class));
                            finish();
                            dialog.dismiss();
                        }
