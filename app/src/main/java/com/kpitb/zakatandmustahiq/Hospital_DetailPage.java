...
public class Hospital_DetailPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital__detail_page);
        ...
        hospital_focal_person_name.setText(DZOName);
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT < 23) {
                    ...
                    if (ActivityCompat.checkSelfPermission(Hospital_DetailPage.this,
                        ...
                        ActivityCompat.requestPermissions((Activity) Hospital_DetailPage.this,
    ...
    private void phoneCall(String dzoPhone) {
        if (ActivityCompat.checkSelfPermission(Hospital_DetailPage.this,
            ...
            Hospital_DetailPage.this.startActivity(callIntent);
        }else{
            Toast.makeText(Hospital_DetailPage.this, "You don't assign permission.", Toast.LENGTH_SHORT).show();
        }
    }
