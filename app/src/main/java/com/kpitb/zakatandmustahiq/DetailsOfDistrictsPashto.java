...
public class DetailsOfDistrictsPashto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_of_districts_pashto);
        ...
        //SETTING DATA
        district_name.setText(DestrictNamePsh);
        dzo_name.setText(DZONamePsh);
        dzo_contact_num.setText(DZOPhone);
        dlzcs_num.setText(NoOfDLZC);
        dzc.setText(ChairMan_Psh);
                ...
                YoYo.with(Techniques.Landing)
                        ...
                        .withListener(new Animator.AnimatorListener() {
                            ...
                            public void onAnimationEnd(Animator animation) {
                                Intent intent1 = new Intent(DetailsOfDistrictsPashto.this,MapsLocation.class);
            ...
            public void onClick(View v) {
                ...
                YoYo.with(Techniques.Landing)
                        ...
                        .withListener(new Animator.AnimatorListener() {
                            ...
                            @Override
                            public void onAnimationEnd(Animator animation) {
                                showClickToCallDialog(DZONamePsh,DZOPhone);
                            }
            ...
            public void onClick(View v) {
                ...
                YoYo.with(Techniques.Landing)
                        ...
                        .withListener(new Animator.AnimatorListener() {
                            ...
                            @Override
                            public void onAnimationEnd(Animator animation) {
                                Intent intent1 = new Intent(DetailsOfDistrictsPashto.this,
                                        DistrictZakatComitteePashto.class);
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT < 23) {
                    ...
                    if (ActivityCompat.checkSelfPermission(DetailsOfDistrictsPashto.this,
                        ...
                        ActivityCompat.requestPermissions((Activity) DetailsOfDistrictsPashto.this,
    ...
    private void phoneCall(String dzoPhone) {
        if (ActivityCompat.checkSelfPermission(DetailsOfDistrictsPashto.this,
            ...
            DetailsOfDistrictsPashto.this.startActivity(callIntent);
        }else{
            Toast.makeText(DetailsOfDistrictsPashto.this, "تاسو اجازه نه لرئ ۔", Toast.LENGTH_SHORT).show();
        }
    }
}