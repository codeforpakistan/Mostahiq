...
import com.kpitb.zakatandmustahiq.Adapter.HospitalListAdapterUrdu;
...
public class ProvincialActivityUrdu extends AppCompatActivity implements SearchView.OnQueryTextListener,
        SwipeRefreshLayout.OnRefreshListener{

    //private SourceList sourceLists;
    private RecyclerView mRecyclerView;
    HospitalListAdapterUrdu myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_provincial_urdu);
        ...
        txt_urdu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txt_urdu.setTextColor(ContextCompat.getColor(ProvincialActivityUrdu.this, R.color.colorPrimaryDark));
        ...
        txt_eng.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txt_eng.setTextColor(ContextCompat.getColor(ProvincialActivityUrdu.this,R.color.colorPrimaryDark));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    myAdapter = new HospitalListAdapterUrdu(ProvincialActivityUrdu.this,sourceListArrayList);
                    myAdapter.notifyDataSetChanged();
                    mRecyclerView.setAdapter(myAdapter);
                    if (myAdapter.getItemCount() == 0){
                        Toast.makeText(ProvincialActivityUrdu.this, "EMPTY", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e)
                {
                    Toast.makeText(ProvincialActivityUrdu.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() != null) {
                    Toast.makeText(ProvincialActivityUrdu.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
                    Log.e("Errror",error.getMessage());
                }
                else {
                    Log.e("Errror",error.getMessage());
                    Toast.makeText(ProvincialActivityUrdu.this, "Server error, try again", Toast.LENGTH_SHORT).show();
                }
            }
        });
    /*    {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(ProvincialActivityUrdu.this);
