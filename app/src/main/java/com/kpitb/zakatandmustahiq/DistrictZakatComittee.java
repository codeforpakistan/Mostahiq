...
import com.kpitb.zakatandmustahiq.Adapter.LZCAdapter;
...
public class DistrictZakatComittee extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_district_zakat_comittee);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (myAdapter.getItemCount() == 0){
                        Toast.makeText(DistrictZakatComittee.this, "EMPTY", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e)
                {
                    Toast.makeText(DistrictZakatComittee.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() != null) {
                    Toast.makeText(DistrictZakatComittee.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
                    Log.e("Errror",error.getMessage());
                }
                else {
                    Log.e("Errror",error.getMessage());
                    Toast.makeText(DistrictZakatComittee.this, "Server error, try again", Toast.LENGTH_SHORT).show();
                }
            }
        });
    /*    {
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT < 23) {
                    ...
                    if (ActivityCompat.checkSelfPermission(DistrictZakatComittee.this,
                        ...
                        ActivityCompat.requestPermissions(DistrictZakatComittee.this, PERMISSIONS_STORAGE, 9);
                    }
                }
