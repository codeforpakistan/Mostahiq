...
import com.kpitb.zakatandmustahiq.Adapter.DistrictAdapterUrdu;
...
public class DistrictsActivityUrdu extends AppCompatActivity implements SearchView.OnQueryTextListener,
        SwipeRefreshLayout.OnRefreshListener{
    //private DistrictModel districtModel;
    private RecyclerView mRecyclerView;
    DistrictAdapterUrdu myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_districts_urdu);
        ...
        txt_urdu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txt_urdu.setTextColor(ContextCompat.getColor(DistrictsActivityUrdu.this, R.color.colorPrimaryDark));
        ...
        txt_eng.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txt_eng.setTextColor(ContextCompat.getColor(DistrictsActivityUrdu.this,R.color.colorPrimaryDark));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    myAdapter = new DistrictAdapterUrdu(DistrictsActivityUrdu.this,districtModelArrayList);
                    mRecyclerView.setAdapter(myAdapter);
                    myAdapter.notifyDataSetChanged();
                    if (myAdapter.getItemCount() == 0){
                        Toast.makeText(DistrictsActivityUrdu.this, "EMPTY", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e)
                {
                    Toast.makeText(DistrictsActivityUrdu.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() != null) {
                    Toast.makeText(DistrictsActivityUrdu.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
                    Log.e("Errror",error.getMessage());
                }
                else {
                    Log.e("Errror",error.getMessage());
                    Toast.makeText(DistrictsActivityUrdu.this, "Server error, try again", Toast.LENGTH_SHORT).show();
                }
            }
        });
    /*    {
   ...
   /* private void setUpRescyclerView() {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(DistrictsActivityUrdu.this);
