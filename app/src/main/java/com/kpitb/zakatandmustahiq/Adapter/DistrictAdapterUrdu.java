...
import com.kpitb.zakatandmustahiq.DetailsOfDistrictsUrdu;
...
public class DistrictAdapterUrdu extends RecyclerView.Adapter<DistrictAdapterUrdu.ViewHolder> {
    ...
    public DistrictAdapterUrdu(Context context, ArrayList<DistrictModel> data) {
...
//        this.filterlist = data;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(final DistrictModel c) {
            dirObj = c;
            request_label.setText(c.getD_name_urdu());
                    ...
                    YoYo.with(Techniques.Landing)
                            ...
                            .withListener(new Animator.AnimatorListener() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    Intent intent = new Intent(context, DetailsOfDistrictsUrdu.class);
