...
import com.kpitb.zakatandmustahiq.DetailsOfLZC_Pashto;
...
public class LZCAdapterPashto extends RecyclerView.Adapter<LZCAdapterPashto.ViewHolder> {
    ...
    public LZCAdapterPashto(Context context, ArrayList<LZCModel> data) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(final LZCModel c) {
            dirObj = c;
            request_label.setText(c.getLzcNamePsh());
                    ...
                    YoYo.with(Techniques.Landing)
                            ...
                            .withListener(new Animator.AnimatorListener() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    Intent intent = new Intent(context, DetailsOfLZC_Pashto.class);
                                    intent.putExtra("LZCName",request_label.getText().toString());
                                    intent.putExtra("TehsilName",c.getTehsilNamePsh());
                                    intent.putExtra("ChairmanName",c.getLzcChairmanPsh());
