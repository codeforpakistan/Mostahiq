...
public class GuzaraAllownceUrdu extends AppCompatActivity /*implements TextToSpeech.OnInitListener*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(GuzaraAllownceUrdu.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(GuzaraAllownceUrdu.this,GuzaraAllowancePashto.class));
                            finish();
                            dialog.dismiss();
                        }
                        else {
                            startActivity(new Intent(GuzaraAllownceUrdu.this,GuzaraAllownce.class));
                            finish();
                            dialog.dismiss();
                        }
