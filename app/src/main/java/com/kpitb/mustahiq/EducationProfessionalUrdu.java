...
public class EducationProfessionalUrdu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_education_professional_urdu);
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(EducationProfessionalUrdu.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(EducationProfessionalUrdu.this,EducationProfessionalPashto.class));
                            finish();
                            dialog.dismiss();
                        }
                        else {
                            startActivity(new Intent(EducationProfessionalUrdu.this,EducationProfessional.class));
                            finish();
                            dialog.dismiss();
                        }
