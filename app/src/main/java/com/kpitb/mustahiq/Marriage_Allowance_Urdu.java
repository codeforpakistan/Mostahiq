...
public class Marriage_Allowance_Urdu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marriage__allowance__urdu);
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(Marriage_Allowance_Urdu.this);
                ...
                btnOK.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            startActivity(new Intent(Marriage_Allowance_Urdu.this,Marriage_Allowance_Pashto.class));
                            finish();
                            dialog.dismiss();
                        }
                        else {
                            startActivity(new Intent(Marriage_Allowance_Urdu.this,MarriageAllownce.class));
                            finish();
                            dialog.dismiss();
                        }
                    }
