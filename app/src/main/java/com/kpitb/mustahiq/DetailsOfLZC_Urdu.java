...
public class DetailsOfLZC_Urdu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_of_l_z_c__urdu);
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT < 23) {
                    ...
                    if (ActivityCompat.checkSelfPermission(DetailsOfLZC_Urdu.this,
                        ...
                        ActivityCompat.requestPermissions((Activity) DetailsOfLZC_Urdu.this,
    ...
    private void phoneCall(String phoneNum) {
        if (ActivityCompat.checkSelfPermission(DetailsOfLZC_Urdu.this,
            ...
            DetailsOfLZC_Urdu.this.startActivity(callIntent);
        }else{
            Toast.makeText(DetailsOfLZC_Urdu.this, "آپ اجازت تفویض نہیں کرتے ۔", Toast.LENGTH_SHORT).show();
        }
