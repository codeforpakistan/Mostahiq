...
public class Hospital_DetailPageUrdu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital__detail_page_urdu);
        ...
        //SETTING DATA
        hospital_name.setText(HospitalNameURD);
        hospital_focal_person_name.setText(DZONameURD);
                ...
                YoYo.with(Techniques.Landing)
                        ...
                        .withListener(new Animator.AnimatorListener() {
                            ...
                            public void onAnimationEnd(Animator animation) {
                                Intent intent1 = new Intent(Hospital_DetailPageUrdu.this,
                                        MapsLocation.class);
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT < 23) {
                    ...
                    if (ActivityCompat.checkSelfPermission(Hospital_DetailPageUrdu.this,
                        ...
                        ActivityCompat.requestPermissions((Activity) Hospital_DetailPageUrdu.this,
    ...
    private void phoneCall(String dzoPhone) {
        if (ActivityCompat.checkSelfPermission(Hospital_DetailPageUrdu.this,
            ...
            Hospital_DetailPageUrdu.this.startActivity(callIntent);
        } else {
            Toast.makeText(Hospital_DetailPageUrdu.this, "آپ اجازت تفویض نہیں کرتے ۔", Toast.LENGTH_SHORT).show();
        }
    }
